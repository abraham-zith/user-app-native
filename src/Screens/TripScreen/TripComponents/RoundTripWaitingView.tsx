...
interface RoundTripWaitingViewProps {
    pickup: string;
    destination: string;
    eta: number;
    tripPhase: TripPhase;
...
const RoundTripWaitingView: React.FC<RoundTripWaitingViewProps> = ({
    pickup,
    destination,
    eta,
    tripPhase,
            ...
            <View style={[styles.progressSection, { backgroundColor: isDark ? appColors.iconBox : appColors.card, borderColor: isDark ? 'rgba(255, 255, 255, 0.05)' : '#F3F4F6', borderWidth: isDark ? 1 : 0 }]}>
                <View style={styles.progressHeader}>
                    <Text style={[styles.statusLabel, { color: appColors.text, fontSize: mS(18) }]}>
                        {status === TripStatus.DAY_HALT ? 'TRIP HALTED (OVERNIGHT)' : 'DRIVER WAITING'}
                    </Text>
                    <LivePulse />
                </View>
                ...
                <View style={styles.timelineArea}>
                    <Text style={{ color: appColors.secondaryText, fontSize: mS(13), marginBottom: vS(10) }}>
                        {status === TripStatus.DAY_HALT
                            ...
                            : 'The driver is waiting at the destination before starting the return trip.'}
                    </Text>
...
export default RoundTripWaitingView;