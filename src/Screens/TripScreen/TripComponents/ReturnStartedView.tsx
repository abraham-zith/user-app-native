...
interface ReturnStartedViewProps {
    pickup: string;
    destination: string;
    eta: number;
    tripPhase: TripPhase;
...
const ReturnStartedView: React.FC<ReturnStartedViewProps> = ({
    pickup,
    destination,
    eta,
    tripPhase,
    ...
    return (
        <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
            ...
            <View style={[styles.progressSection, { backgroundColor: isDark ? appColors.iconBox : appColors.card, borderColor: isDark ? 'rgba(255, 255, 255, 0.05)' : '#F3F4F6', borderWidth: isDark ? 1 : 0 }]}>
                ...
                <View style={styles.timelineArea}>
                    <Text style={{ color: appColors.secondaryText, fontSize: mS(13), marginBottom: vS(10) }}>
                        The driver has started the return trip and is heading back to the pickup location.
                    </Text>
            ...
            <View style={[styles.zone1, { backgroundColor: isDark ? appColors.iconBox : appColors.card, borderColor: isDark ? 'rgba(255, 255, 255, 0.05)' : '#F3F4F6' }]}>
                ...
                {/* Right: Return Status info */}
                <View style={styles.glanceRight}>
                    <Text style={[styles.hugeEta, { color: appColors.text, fontSize: mS(18) }]}>
                        In Progress
                    </Text>
                    <View style={styles.statusIndicator}>
                        <View style={[styles.onTimeDot, { backgroundColor: '#10B981' }]} />
                        <Text style={[styles.onTimeText, { color: '#10B981' }]}>Returning</Text>
                    </View>
                </View>
            </View>
...
export default ReturnStartedView;